...
def document_xml() -> str:
    ...
    parts = [
        ...
        bullet("Time constraint: the original scope spans many modules, so this iteration prioritizes a fully working demo of the five core screens over breadth."),
        ...
        bullet("Scope management: validation and data flow were prioritized over the trainer/workout/equipment/reports modules, which were intentionally deferred to a later iteration."),
        ...
        placeholder("Screenshot 6: Login Error State",
