...
def document_xml() -> str:
    ...
    parts = [
        ...
        bullet("Trainer, Workout Plan, and Equipment modules: designed in the project scope but UI and data model are not yet implemented in this iteration."),
        ...
        bullet("Scope management: validation and data flow were prioritized over the trainer/workout/equipment modules, which were intentionally deferred to a later iteration."),
