...
def document_xml() -> str:
    ...
    parts = [
        ...
        bullet("Scope management: validation and data flow were prioritized over the workout/equipment modules, which were intentionally deferred to a later iteration."),
        ...
        placeholder("Screenshot 8: Login Error State",
